...
//
//  Copyright (c) 2015 Hesham Saleh & Yahya Alaa. All rights reserved.
//
#include <stdio.h>
#include <string.h>
#include <strings.h>
...
int main()
{
    ...
    FILE *fp;
    fp = fopen("Test Cases/input_1.txt","r");
...
{"the","but","I","if","likewise","however","while","why","also","nor","any","for","if","a","an","in","on","at","it","he","she","so","from","to","and","or","his","her","of","my","as","we"};
    ...
    f1=fopen("Test Cases/output_1.txt","w");
    ...
    fprintf(f1,"\n- Powered by the Automatic Extraction-based Text Summarization tool.\n- Developed by Hesham Saleh & Yahya Alaa.");
